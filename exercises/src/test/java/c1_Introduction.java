...
public class c1_Introduction extends IntroductionBase {
    ...
    public void hello_world() {
        ...
        // The block method is like a subscribe method, it will subscribe and wait for the result
    ...
    public void unresponsive_service() {
        Exception exception = assertThrows(IllegalStateException.class, () -> {
            ...
            // Subscribe and wait for the result, but only for 1 second
            serviceResult.block(Duration.ofSeconds(1)); //todo: change this line only
        });
    ...
    public void multi_result_service() {
        ...
        // Retrieve first item from Flux using blocking operator
    ...
    public void fortune_top_five() {
        ...
        // Use collectList to collect all emitted items into a Mono<List<String>> and then block on it
